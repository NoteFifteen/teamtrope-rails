...
[
  ...
  { phase: { project_view_id: 1, name: "Edit Content",   color: "red",     color_value: "#E6583E", icon: "icon-pencil", order: 2},     tabs: [ {task_id: :manuscript_development, order: 1}, {task_id: :original_manuscript,    order: 2}, # TTR-86 {task_id: :first_pass_edit,    order: 3},
{task_id: :edited_manuscript, order: 4}, {task_id: :proofed_manuscript,    order: 5}, {task_id: :proofread_complete,   order: 6}]},
