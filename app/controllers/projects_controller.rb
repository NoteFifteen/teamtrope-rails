class ProjectsController < ApplicationController
  ...
  def update_project_params
    params.require(:project).permit(:id, :final_title, :title, :synopsis, :stock_image_request_link,
      ...
      :netgalley_submission_attributes => [:title, :isbn, :publication_date, :author_name, :retail_price, :blurb, :category_one, :category_two, :praise, :website_one, :website_two, :website_three],
