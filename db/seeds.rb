...
tasks =  {
  ...
  :revenue_split =>                 { task: { workflow_id: nil,          next_id: nil,   rejected_task_id: nil,   partial: "revenue_split",            name: "Revenue Split",             icon: "icon-money",       tab_text: "Revenue Split",             intro_video: "" ,  days_to_complete: nil }, unlocked: []},
	...
	:project_details =>               { task: { workflow_id: nil,          next_id: nil,   rejected_task_id: nil,   partial: "project_details",          name: "Project Details",           icon: "icon-file-alt",    tab_text: "Details & Synopsis",        intro_video: "" ,  days_to_complete: nil }, unlocked: []},
	:assets =>                        { task: { workflow_id: nil,          next_id: nil,   rejected_task_id: nil,   partial: "assets",                   name: "Assets",                    icon: "icon-folder-open", tab_text: "Assets & Files",            intro_video: "" ,  days_to_complete: nil }, unlocked: []},
