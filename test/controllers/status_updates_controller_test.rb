...
class StatusUpdatesControllerTest < ActionController::TestCase
  ...
  test "should create status_update" do
    assert_difference('StatusUpdate.count') do
      post :create, status_update: { project_id: @status_update.project_id, status: @status_update.status, type_index: @status_update.type_index }
    end
  ...
  test "should update status_update" do
    patch :update, id: @status_update, status_update: { project_id: @status_update.project_id, status: @status_update.status, type_index: @status_update.type_index }
    assert_redirected_to status_update_path(assigns(:status_update))
  end
