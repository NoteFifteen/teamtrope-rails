...
tasks =  {
  ...
  :approve_cover_art =>             { task: { workflow_id: :design,      next_id: :upload_cover_templates, rejected_task_id: :upload_cover_concept,   partial: "approve_cover_art",        name: "Approve Cover Art",         icon: "icon-thumbs-up",   tab_text: "Approve Cover Art",                  intro_video: "" ,  days_to_complete: nil }, unlocked: ["Request Image", "Add Image", "Cover Concept"], performers: []},
  :upload_cover_templates =>        { task: { workflow_id: :design,      next_id: :final_cover_approval,   rejected_task_id: nil,                     partial: "upload_cover_templates",   name: "Final Covers",              icon: "icon-cloud-upload",tab_text: "Final Covers",                   intro_video: "" ,  days_to_complete: nil }, unlocked: ["Request Image", "Add Image", "Cover Concept"], performers: ['Author', 'Cover Designer', 'Project Manager']},
  :final_cover_approval =>          { task: { workflow_id: :design,      next_id: :design_complete,        rejected_task_id: :upload_cover_templates, partial: "approve_final_cover",     name: "Approve Final Covers",      icon: "icon-thumbs-up",   tab_text: "Approve Final Covers",           intro_video: "",   days_to_complete: nil }, unlocked: ["Request Image", "Add Image"], performers: ['Author', 'Cover Designer', 'Project Manager']},
  ...
  :approve_blurb =>           		  { task: { workflow_id: :marketing,   next_id: :submit_publication_fact_sheet, rejected_task_id: :submit_blurb,   partial: "approve_blurb",      name: "Approve Blurb",      icon: "icon-thumbs-up",   tab_text: "Approve Blurb",         intro_video: "" ,  days_to_complete: nil }, unlocked: [], performers: ['Author', 'Book Manager', 'Project Manager']},
  ...
  :update_blurb =>                  { task: { workflow_id: nil,          next_id: nil,   rejected_task_id: nil,   partial: "submit_blurb",             name: "Update Blurb",              icon: "icon-bullhorn",    tab_text: "Update Blurb",              intro_video: "" ,  days_to_complete: nil }, unlocked: [], performers: ['Author', 'Book Manager', 'Project Manager']},
...
[
  ...
  { phase: { project_view_id: 1, name: "Marketing Prep", color: "green", color_value: "#AED991", icon: "icon-bullhorn", order: 3},    tabs: [ {task_id: :submit_blurb,           order: 1}, {task_id: :approve_blurb,          order: 2}, {task_id: :submit_publication_fact_sheet, order: 3}, {task_id: :update_blurb, order: 4}]},
