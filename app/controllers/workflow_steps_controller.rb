class WorkflowStepsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @workflow_step.save
        format.html { redirect_to @workflow_step, notice: 'Workflow task was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @workflow_step.update(workflow_step_params)
        format.html { redirect_to @workflow_step, notice: 'Workflow task was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to workflow_steps_url, notice: 'Workflow task was successfully destroyed.' }
  ...
  private
    ...
    def workflow_step_params
      params.require(:workflow_step).permit(:workflow_id, :task_id, :next_step_id, :rejected_step_id)
    end
end
