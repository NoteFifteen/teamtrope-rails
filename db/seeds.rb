...
tasks =  {
  ...
  :blurb_submit => 									{ task: { workflow_id: :marketing,   next_id: :blurb_approve,         rejected_task_id: nil,   partial: "submit_publication_fact_sheet", name: "Blurb Submit",       icon: "icon-bookmark",    tab_text: "Blurb Submit",          intro_video: "" ,  days_to_complete: nil }, root: true, unlocked: [], performers: ['Author', 'Book Manager', 'Project Manager']},
  :blurb_approve =>           		  { task: { workflow_id: :marketing,   next_id: :submit_publication_fact_sheet, rejected_task_id: nil,   partial: nil,                     name: "Blurb Approve",      icon: "icon-thumbs-up",   tab_text: "Blurb Approve",         intro_video: "" ,  days_to_complete: nil }, unlocked: []}, performers: ['Author', 'Book Manager', 'Project Manager']},
  :submit_publication_fact_sheet => { task: { workflow_id: :marketing,   next_id: :marketing_complete,    rejected_task_id: nil,   partial: "submit_publication_fact_sheet", name: "PFS",                icon: "icon-bookmark",    tab_text: "Fact Sheet",            intro_video: "" ,  days_to_complete: nil }, unlocked: [], performers: ['Author', 'Book Manager', 'Project Manager']},
...
[
  ...
  { phase: { project_view_id: 1, name: "Marketing Prep", color: "green", color_value: "#AED991", icon: "icon-bullhorn", order: 3},    tabs: [ {task_id: :blurb_submit,           order: 1}, {task_id: :blurb_approve,      order: 2}, {task_id: :market_release_date,    order: 3}, {task_id: :submit_publication_fact_sheet, order: 4}]},
  ...
  { phase: { project_view_id: 1, name: "Design Cover", color: "blue", color_value: "#1394BB", icon: "icon-screenshot", order: 5},     tabs: [ {task_id: :upload_cover_concept,   order: 1}, {task_id: :approve_cover_art,  order: 2}, {task_id: :request_image,     order: 3}, {task_id: :add_image,          order: 4}, {task_id: :upload_cover_templates, order: 5}]},
