...
tasks =  {
  ...
  :submit_blurb => 									{ task: { workflow_id: :marketing,   next_id: :approve_blurb,                 rejected_task_id: nil,   partial: "submit_publication_fact_sheet", name: "Submit Blurb",       icon: "icon-bookmark",    tab_text: "Submit Blurb",          intro_video: "" ,  days_to_complete: nil }, root: true, unlocked: [], performers: ['Author', 'Book Manager', 'Project Manager']},
  :approve_blurb =>           		  { task: { workflow_id: :marketing,   next_id: :submit_publication_fact_sheet, rejected_task_id: nil,   partial: nil,                             name: "Approve Blurb",      icon: "icon-thumbs-up",   tab_text: "Approve Blurb",         intro_video: "" ,  days_to_complete: nil }, unlocked: [], performers: ['Author', 'Book Manager', 'Project Manager']},
