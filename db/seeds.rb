...
tasks =  {
  ...
  :upload_cover_templates =>        { task: { workflow_id: :design,      next_id: :final_cover_approval,   rejected_task_id: nil,                    partial: "upload_cover_templates",   name: "Final Covers",              icon: "icon-cloud-upload",tab_text: "Final Covers",           intro_video: "" ,  days_to_complete: nil }, unlocked: ["Request Image", "Add Image"], performers: ['Author', 'Cover Designer', 'Project Manager']},
