...
tasks =  {
  ...
  :submit_publication_fact_sheet => { task: { workflow_id: :marketing,   next_id: :marketing_complete,    rejected_task_id: nil,   partial: "submit_publication_fact_sheet",   name: "PFS",          icon: "icon-bookmark",    tab_text: "Fact Sheet",            intro_video: "" ,  days_to_complete: nil }, root: true, unlocked: []},
