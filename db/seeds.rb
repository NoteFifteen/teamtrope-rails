...
tasks =  {
  ...
  :approve_cover_art =>             { task: { workflow_id: :design,      next_id: :upload_cover_templates, rejected_task_id: :upload_cover_concept, partial: "approve_cover_art",        name: "Approve Cover Art",         icon: "icon-thumbs-up",   tab_text: "Approve Cover",          intro_video: "" ,  days_to_complete: nil }, unlocked: ["Request Image", "Add Image"], performers: []},
...
#creating phases
[
  { phase: { project_view_id: 1, name: "Overview", color: "white", color_value: "#eee", icon: "icon-dashboard", order: 0},            tabs: [ {task_id: :project_details,        order: 1}, {task_id: :assets,                 order: 2}, {task_id: :team,              order: 3}, {task_id: :analytics,          order: 4},{task_id: :update, order: 5}, {task_id: :control_numbers, order: 6}, {task_id: :activity, order: 7}]},
  ...
  { phase: { project_view_id: 1, name: "Marketing Prep", color: "green", color_value: "#AED991", icon: "icon-bullhorn", order: 3},    tabs: [ {task_id: :submit_blurb,           order: 1}, {task_id: :approve_blurb,          order: 2}, {task_id: :submit_publication_fact_sheet, order: 4}, {task_id: :market_release_date,    order: 3}]},
