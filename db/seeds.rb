...
tasks =  {
  ...
  :edited_manuscript =>             { task: { workflow_id: :production,  next_id: :submit_proofread,    rejected_task_id: nil,   partial: "edited_manuscript",        name: "In Editing",                icon: "icon-edit",        tab_text: "Edited Manuscript",  intro_video: "",  days_to_complete: nil }, unlocked: ["1099 Form", "Accept Member", "Assets", "Activity", "Edit Complete Date", "Project Details", "Revenue Split", "Team Change", "Rights Back Request", "Submit Edited",  "Artwork Rights Request", "Team", "Social Media Marketing Edit", "Social Media Marketing View"], performers: ['Author', 'Editor', 'Project Manager']},

  :submit_to_layout =>              { task: { workflow_id: :production,  next_id: :approve_layout,      rejected_task_id: nil,   partial: "submit_to_layout",         name: "Submit to Layout",          icon: "icon-ok-sign",     tab_text: "Submit to Layout",   intro_video: "",  days_to_complete: nil }, unlocked: ["1099 Form", "Accept Member", "Assets", "Activity", "Project Details", "Proofed Manuscript", "Revenue Split", "Team Change", "Rights Back Request", "Team", "Control Numbers", "Artwork Rights Request", "Social Media Marketing Edit", "Social Media Marketing View"], performer: ['Author', 'Project Manager', 'Book Manager'] },

  :upload_layout =>                 { task: { workflow_id: :production,  next_id: :approve_layout,      rejected_task_id: nil,   partial: "upload_layout",            name: "Upload Layout",             icon: "icon-cloud-upload",tab_text: "Upload Layout",      intro_video: "",  days_to_complete: nil }, unlocked: ["1099 Form", "Accept Member", "Assets", "Activity", "Project Details", "Revenue Split", "Team Change", "Rights Back Request", "Upload Layout", "Team", "Artwork Rights Request", "Social Media Marketing Edit", "Social Media Marketing View"], performers: []},
  :approve_layout =>                { task: { workflow_id: :production,  next_id: :check_imprint,       rejected_task_id: nil,   partial: "approve_layout",           name: "Approve Layout",            icon: "icon-thumbs-up",   tab_text: "Approve Layout",     intro_video: "",  days_to_complete: nil }, unlocked: ["1099 Form", "Accept Member", "Assets", "Activity", "Project Details", "Team", "Revenue Split", "Team Change", "Rights Back Request", "Artwork Rights Request", "Approve Layout", "Social Media Marketing Edit", "Social Media Marketing View"], performers: ['Author']},
  :check_imprint =>                 { task: { workflow_id: :production,  next_id: :page_count,          rejected_task_id: nil,   partial: "check_imprint",            name: "Check Imprint",             icon: "icon-cogs",        tab_text: "Check Imprint",      intro_video: "",  days_to_complete: nil }, unlocked: ["1099 Form", "Accept Member", "Assets", "Activity", "Project Details", "Team", "Revenue Split", "Team Change", "Rights Back Request", "Artwork Rights Request", "Check Imprint", "Social Media Marketing Edit", "Social Media Marketing View"],  performers: []},
  :page_count =>                    { task: { workflow_id: :production,  next_id: :final_manuscript,    rejected_task_id: nil,   partial: "page_count",               name: "Page Count",                icon: "icon-list-ol",     tab_text: "Page Count",         intro_video: "",  days_to_complete: nil }, unlocked: ["1099 Form", "Accept Member", "Assets", "Activity", "Final Page Count", "Project Details", "Revenue Split", "Team Change", "Rights Back Request", "Team", "Artwork Rights Request", "Social Media Marketing Edit", "Social Media Marketing View"], performers: []},
  :final_manuscript =>              { task: { workflow_id: :production,  next_id: :publish_book,        rejected_task_id: nil,   partial: "final_manuscript",         name: "Final Manuscript",          icon: "icon-bookmark",    tab_text: "Final Manuscript",   intro_video: "",  days_to_complete: nil }, unlocked: ["1099 Form", "Accept Member", "Assets", "Activity", "Final Manuscript", "Project Details", "Revenue Split", "Team Change", "Rights Back Request", "Team", "Artwork Rights Request", "Social Media Marketing Edit", "Social Media Marketing View"], performers: []},
  :publish_book =>                  { task: { workflow_id: :production,  next_id: :production_complete, rejected_task_id: nil,   partial: "publish_book",             name: "Publish Book",              icon: "icon-star",        tab_text: "Publish Book",       intro_video: "",  days_to_complete: nil }, unlocked: ["1099 Form", "Accept Member", "Assets", "Activity", "Project Details", "Publish Book", "Revenue Split", "Team Change", "Rights Back Request", "Team", "Production Expense", "Artwork Rights Request", "Control Numbers", "Social Media Marketing Edit", "Social Media Marketing View"], performers: []},
  :production_complete =>           { task: { workflow_id: :production,  next_id: nil,                  rejected_task_id: nil,   partial: nil,                        name: "Production Complete",       icon: "",                 tab_text: "",                   intro_video: "",  days_to_complete: nil }, unlocked: ["1099 Form", "Accept Member", "Assets", "Activity", "Blog Tour", "Netgalley Submission Form", "Media Kit", "Project Details", "Promos", "Revenue Split", "Team Change", "Rights Back Request", "Print", "Control Numbers", "Analytics", "Artwork Rights Request", "Team",  "Marketing Expense", "KDP Select Enrollment", "KDP Select Update", "Social Media Marketing Edit", "Social Media Marketing View", "ebook Only Incentive", "Bookbub Submission"]},
  ...
  :marketing_complete =>            { task: { workflow_id: :marketing,   next_id: nil,                            rejected_task_id: nil,           partial: nil,                             name: "Marketing Complete", icon: "",               tab_text: "",               intro_video: "" ,  days_to_complete: nil }, unlocked: ['Update Genre', "ebook Only Incentive"]},
  ...
  # secret form
  :rights_back_request =>           { task: { workflow_id: nil,          next_id: nil,   rejected_task_id: nil,   partial: 'rights_back_request',         name: 'Rights Back Request',         icon: 'icon-exchange',    tab_text: 'Rights Back Request',  intro_video: "" ,  days_to_complete: nil }, unlocked: []},

  # Edit Content
  :proofed_manuscript =>            { task: { workflow_id: nil,          next_id: nil,   rejected_task_id: nil,   partial: "submit_blurb",                name: "Proofed Manuscript",          icon: "icon-edit",        tab_text: "Proofed Manuscript",   intro_video: "" ,  days_to_complete: nil }, unlocked: [], performers: ['Author', "Book Manager", 'Proofreader']},
  ...
  :ebook_only_incentive =>          { task: { workflow_id: nil,          next_id: nil,   rejected_task_id: nil,   partial: "ebook_only_incentive",        name: "ebook Only Incentive",        icon: "icon-book",        tab_text: "ebook Only Incentive", intro_video: "" ,  days_to_complete: nil }, unlocked: [], performers: ['Author', 'Book Manager']},
  :netgalley_submission =>          { task: { workflow_id: nil,          next_id: nil,   rejected_task_id: nil,   partial: "netgalley_submission_form",   name: "Netgalley Submission",        icon: "icon-money",       tab_text: "Netgalley Submission", intro_video: "" ,  days_to_complete: nil }, unlocked: [], performers: ['Author', 'Book Manager']},
  ...
  :social_media_marketing_edit =>   { task: { workflow_id: nil,          next_id: nil,   rejected_task_id: nil,   partial: "social_media_marketing_edit", name: "Social Media Marketing Edit", icon: "icon-cogs",        tab_text: "Update Social Media",  intro_video: "" ,  days_to_complete: nil }, unlocked: [], performers: ['Author', 'Book Manager']},
  :social_media_marketing_view =>   { task: { workflow_id: nil,          next_id: nil,   rejected_task_id: nil,   partial: "social_media_marketing_view", name: "Social Media Marketing View", icon: "icon-file-alt",    tab_text: "Social Media",         intro_video: "" ,  days_to_complete: nil, team_only: false }, unlocked: []},
  ...
  :bookbub_submission =>            { task: { workflow_id: nil,          next_id: nil,   rejected_task_id: nil,   partial: "bookbub_submission",          name: "Bookbub Submission",          icon: "icon-file-alt",    tab_text: "Bookbub Submission",   intro_video: "" ,  days_to_complete: nil, team_only: false }, unlocked: []},
...
[
  ...
  { phase: { project_view_id: 1, name: "Build Team",     color: "yellow",  color_value: "#F0D818", icon: "icon-wrench", order: 1},     tabs: [ {task_id: :accept_member,          order: 1}, {task_id: :form_1099,              order: 2}, {task_id: :revenue_split,     order: 3}, {task_id: :team_change,        order: 4}, {task_id: :rights_back_request, order: 5}]},
  { phase: { project_view_id: 1, name: "Edit Content",   color: "red",     color_value: "#E6583E", icon: "icon-pencil", order: 2},     tabs: [ {task_id: :manuscript_development, order: 1}, {task_id: :original_manuscript,    order: 2}, {task_id: :edited_manuscript, order: 3}, {task_id: :proofed_manuscript, order: 4}, {task_id: :submit_to_layout,   order: 5}]},
  ...
  { phase: { project_view_id: 1, name: "Design Layout",  color: "medblue", color_value: "#0078c0", icon: "icon-screenshot", order: 4}, tabs: [ {task_id: :upload_layout,          order: 1}, {task_id: :approve_layout,         order: 2}, {task_id: :check_imprint,     order: 3}, {task_id: :page_count,         order: 4}]},
  ...
  { phase: { project_view_id: 1, name: "Marketing",      color: "green",   color_value: "#AED991", icon: "icon-bullhorn", order: 7},   tabs: [ {task_id: :media_kit,              order: 1}, {task_id: :print_corner,           order: 2}, {task_id: :netgalley_submission, order: 3}, {task_id: :ebook_only_incentive, order: 4}, {task_id: :bookbub_submission,  order: 5}, {task_id: :price_promotion, order: 6}, {task_id: :social_media_marketing_view, order: 7}, {task_id: :social_media_marketing_edit, order: 8}]},
