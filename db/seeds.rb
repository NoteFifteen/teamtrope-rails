...
[
  ...
  { phase: { project_view_id: 1, name: "Marketing Prep", color: "green",   color_value: "#AED991", icon: "icon-bullhorn", order: 3},   tabs: [ {task_id: :submit_blurb,           order: 1}, {task_id: :approve_blurb,          order: 2}, {task_id: :submit_publication_fact_sheet, order: 3}, {task_id: :update_blurb, order: 4}, {task_id: :update_genre, order: 5}]},
